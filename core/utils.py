...
def create_folder(playPath, path):
    ...
    if path in available:
        ...
        print(
            "You can find your downloaded MUSIC in : ",
            os.path.abspath(f"{path}/{playPath}"),
        )
        ...
        print(
            "You can find your downloaded MUSIC in : ",
            os.path.abspath(f"{path.capitalize()}/{playPath}"),
        )
...
def format_size(bytes):
    ...
    puisx = {0: "B", 10: "KB", 20: "MB", 30: "GB", 40: "TB"}
    unit = puisx[puiss]
